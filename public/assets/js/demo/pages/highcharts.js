...
var demoHighCharts = function () {
        ...
        var highColors = [adColors.bgDanger, adColors.bgWarning, adColors.bgSystem, adColors.bgPrimary, adColors.bgInfo, adColors.bgAlert,
             adColors.bgSuccess, adColors.bgDark
        ];
                ...
                var sparklineInit = function() {
                        $('.inlinesparkline').each(function(i, e) {
                            ...
                            $(e).sparkline('html', {
                                ...
                                highlightSpotColor: adColors.bgWarningDr,
                                highlightLineColor: adColors.bgWarningLr
                            });
                        });
                }
        ...
        var demoCircleGraphs = function() {
            ...
            if (infoCircle.length) {
                // Color Library we used to grab a random color
                var colors = {
                    "danger": [adColors.bgDanger, adColors.bgDangerLr,
                        adColors.bgDangerDr
                    ],
                    "primary": [adColors.bgPrimary, adColors.bgPrimaryLr,
                        adColors.bgPrimaryDr
                    ],
                    "info": [adColors.bgInfo, adColors.bgInfoLr, adColors.bgInfoDr],
                    "warning": [adColors.bgWarning, adColors.bgWarningLr,
                        adColors.bgWarningDr
                    ],
                    "success": [adColors.bgSuccess, adColors.bgSuccessLr,
                        adColors.bgSuccessDr
                    ],
                    "alert": [adColors.bgAlert, adColors.bgAlertLr, adColors.bgAlertDr]
                };
                // Store all circles
                ...
                infoCircle.each(function(i, e) {
                    ...
                    var color = ['#DDD', adColors.bgDanger];
                ...
                var lazyLayout = Core.debounce(rescale, 300);
