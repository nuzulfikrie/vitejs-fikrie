...
var demoHighCharts = function () {
        ...
        var highColors = [adColors.bgWarning, adColors.bgPrimary, adColors.bgInfo, adColors.bgAlert,
            adColors.bgDanger, adColors.bgSuccess, adColors.bgSystem,adColors.bgDark
        ];
            ...
            var demoHighColumns = function() {
                 ...
                 if (column2.length) {
                    ...
                    $('#high-column2').highcharts({
                        credits: false,
                        colors: [adColors.bgPrimary, adColors.bgPrimary, adColors.bgWarning,
                            adColors.bgWarning, adColors.bgInfo, adColors.bgInfo
                        ],
                        chart: {
                            padding: 0,
                            marginTop: 25,
