 ...
 * @returns 
 */
const PanelNotCompleted: React.FC<PanelProps> = ({title ,identifier, podIndicator, content,addButtonDisabled,addData}) => {
        ...
        return (
            ...
            <div className="panel panel-danger">
                ...
                <div className="panel-body">
                    <div className="p2" id="filter_one_content">{content}</div>
                </div>
                <div className='panel-footer'>
                    <div className='btn-group'>
                        <AddButton onClick={addData} identifier={identifier} title={title} content={content} buttonEnabled={addButtonDisabled}  />
                    </div>
                </div>
            </div>
            </>
